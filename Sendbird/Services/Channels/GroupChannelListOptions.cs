...
{
    public class GroupChannelListOptions : ListOptions
    {
        [JsonProperty("token")]
        ...
        [JsonProperty("include_sorted_metaarray_in_last_message")]
        public bool IncludeSortedMetaarrayInLastMessage { get; set; }
    }
}
